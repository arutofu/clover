...
> **Внимание** Длина пароля для Wi-Fi сети должна быть **не менее** 8 символов.
>
...
> **Внимание** Для редактирования некоторых файлов, к которым у вас не будет доступа, необходимо использовать **sudo nano**, вместо **nano**.
...
> **Заметка** Если интерфейс является беспроводным (wlan), то служба `dhcpcd` триггерит `wpa_supplicant`, который в свою очередь работает непосредственно с wifi-адаптером и переводит его в заданное состояние.
