...
## $\color{red}{\textsf{🔴уточнить о прошивке}}$ Загрузка прошивки в полетный контроллер 
...
4. Для Клевера 4 выберите подтипа рамы *COEX Clover 4*. В ином случае – *Generic Quadrotor X* $\color{red}{\textsf{🔴какие у нас рамы?}}$.
...
$\color{red}{\textsf{🔴какие у нас настройки PID для каждого дрона?}}$
