...
1. [«Знакомство. Принципы проектирования и строение мультикоптеров»](#title1)
2. [«Основы электричества»](#title2)
3. [«Теория пайки»](#title3)
4. [«Аэродинамика полета. Пропеллер»](#title4)
5. [«Основы электромагнетизма. Типы двигателей](#title5)
6. [«Бесколлекторные двигатели и регуляторы их хода»](#title6)
7. [«Принцип работы, типы и устройство аккумуляторов»](#title7)
8. [«Управление полетом мультикоптера. Принцип функционирования полетного контроллера. ПИД регуляторы»](#title8)
9. [«Основы радиосвязи. Принцип работы радиоаппаратуры управления»](#title9)
10. [«Аналоговая и цифровая видеотрансляция. Применяемые камеры, радиопередатчики и приемники»](#title10)
11. [«Техника безопасности при сборке и настройке коптеров, при подготовке к вылету. Техника безопасности при работе с аккумуляторами»](#title11)
12. [«Теория ручного визуального пилотирования»](#title12)
13. [«Техника безопасности при летной эксплуатации коптера»](#title13)
14. [«Обучение лётному мастерству»](#title14)
15. [«Основы радиоэлектроники, схемотехники и макетирования электрических схем»](#title15)
16. [«Основы работы с аналоговым и цифровым сигналом»](#title16)
17. [«Основы работы с лабораторным оборудованием»](#title17)
18. [«Теория FPV полетов»](#title18)
19. [«История автономных полетов. Развитие автопилотов в авиации»](#title19)
20. [«Основы программирование на языке Python»](#title20)
21. [«Знакомство с компьютером Raspberry Pi»](#title21)
22. [«Управление автономным дроном: теория»](#title22)

Методика проведения занятий
---------------------------

## <a id="title1">Урок №1. Тема: «Знакомство. Принципы проектирования и строение мультикоптеров»</a>
...
| 7 | Виды и конфигурация дронов | Рассказать ученикам о видах коптеров и зарисовать направление вращения моторов на каждом из них.<ul><li>трикоптер,</li><li>гексакоптер,</li><li>октокоптер,</li><li>квадрокоптер.</li></ul> Спросить ребят, что, по их мнению, даёт разное количество пропеллеров, в конце сделав акцент на то, что квадрокоптеры самые простые из них в сборке и управлении. Показать ученикам два вида конфигурации дронов + и X и их отличие. |
...
## <a id="title2">Урок №2. Тема: «Основы электричества»</a>
...
## <a id="title4">Урок №4. Тема: «Аэродинамика полета. Пропеллер»</a>

**Цель урока:** Сформировать знания основных принципов аэродинамики пропеллеров. Дать
представление о главных характеристиках винта, и их влияние на полетные качества
коптера. Научить ориентироваться в технических таблицах по подбору пропеллеров и
моторов.
...
## <a id="title5">Урок №5. Тема: «Основы электромагнетизма. Типы двигателей</a>
...
## <a id="title6">Урок №6. Тема: «Бесколлекторные двигатели и регуляторы их хода»</a>
...
## <a id="title8">Урок №8. Тема: «Управление полетом мультикоптера. Принцип функционирования полетного контроллера. ПИД регуляторы»</a>
...
## <a id="title9">Урок №9. Тема: «Основы радиосвязи. Принцип работы радиоаппаратуры управления»</a>
...
## <a id="title10">Урок №10. Тема: «Аналоговая и цифровая видеотрансляция. Применяемые камеры, радиопередатчики и приемники»</a>
...
## <a id="title11">Урок №11. Тема: «Техника безопасности при сборке и настройке коптеров, при подготовке к вылету. Техника безопасности при работе с аккумуляторами»</a>
...
## <a id="title13">Урок №13. Тема: «Техника безопасности при летной эксплуатации коптера»</a>
...
## <a id="title14">Урок №14. Тема: «Обучение лётному мастерству»</a>
...
## <a id="title15">Урок №15. Тема: «Основы радиоэлектроники, схемотехники и макетирования электрических схем»</a>
...
## <a id="title16">Урок №16. Тема: «Основы работы с аналоговым и цифровым сигналом»</a>
...
## <a id="title17">Урок №17. Тема: «Основы работы с лабораторным оборудованием»</a>
...
## <a id="title18">Урок №18. Тема: «Теория FPV полетов»</a>
...
## <a id="title19">Урок №19. Тема: «История автономных полетов. Развитие автопилотов в авиации»</a>
...
## <a id="title20">Урок №20. Тема: «Основы программирование на языке Python»</a>
...
## <a id="title21">Урок №21. Тема: «Знакомство с компьютером Raspberry Pi»</a>
...
| 8 | Использование QGroundControl через Wi-Fi | Настроить беспроводное соединение для работы в QGroundControl. Предложить учащимся установить новую прошивку, которая подходит для автономных полетов и откалибровать коптер при беспроводном подключении. |
...
## <a id="title22">Урок №22. Тема: «Управление автономным дроном: теория»</a>
