...
* [Видеоинструкция калибровки](https://www.tezona.ru/data/uploads/files/osa-kalibrovka.mp4)
...
Сбрасываем ошибки, верхние тумблеры подняты, левый стик опущен.
...
Находим на приемнике кнопку BND (крайняя). Для корректной работы провода желательно развести на 90 градусов.

<img src="../assets/assembling_drone1/15-23/21.png" width=180 class="zoom border center">
...
<img src="../assets/assembling_drone1/15-23/23.png" width=180 class="zoom border center">
...
<img src="../assets/assembling_drone1/25-26/25.1.png" width=353 class="zoom border center">
...
## Крепление двигателей к раме (выполняется одновременно с креплением элемента защиты)
...
Удаляем бокорезами излишки хомутов. Обязательно применять средства индивидуальной защиты (очки).
...
<img src="../assets/assembling_drone1/38/38.2.png" width=220 class="zoom border center">
