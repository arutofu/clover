...
<table class="type_table">
    <tr>
        <td><img src="../assets/assembling_drone1/composition/1.png" width=130 class="center"></td>
        <td>x1</td>
        <td><img src="../assets/assembling_drone1/composition/2.png" width=130 class="center"></td>
        <td>x1</td>
    </tr>
</table>
