...
<img src="../assets/sensors/time/module_time.png" width=300 class="zoom border center"></img>

## Подключение

<img src="../assets/sensors/time/time_connection.svg" width=350 class="zoom border center"></img>
