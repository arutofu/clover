...
Вы можете скачать PDF-версию ${\textsf{\color{lightred}***ссылку добавим когда будет готово***}}$ этой документации. ${\textsf{\color{lightred}***будет версия документации на английском языке?***}}$.
${\textsf{\color{lightred}Green}}$
