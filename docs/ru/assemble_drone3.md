...
Проверьте, корректно ли установлен драйвер на вашем компьютере. Пример: «Мой компьютер» — «Управление» — COM3 — означает что все корректно:

<img src="../assets/assembling_drone3_1/6/1.png" width=400 class="zoom border center"></img>

[Если нет COM-порта, значит драйвер не установлен. Загрузите и установите драйвер.](https://www.tezona.ru/download/avia-application/)
